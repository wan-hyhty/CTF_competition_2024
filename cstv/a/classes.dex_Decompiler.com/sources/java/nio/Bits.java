...
class Bits {
    ...
    static final /* synthetic */ boolean f11assertionsDisabled = false;
    ...
    private static char makeChar(byte b1, byte b0) {
        return (char) ((b1 << 8) | (b0 & Character.DIRECTIONALITY_UNDEFINED));
    }
    ...
    private static short makeShort(byte b1, byte b0) {
        return (short) ((b1 << 8) | (b0 & Character.DIRECTIONALITY_UNDEFINED));
    }
    ...
    private static int makeInt(byte b3, byte b2, byte b1, byte b0) {
        return (b3 << 24) | ((b2 & Character.DIRECTIONALITY_UNDEFINED) << 16) | ((b1 & Character.DIRECTIONALITY_UNDEFINED) << 8) | (b0 & Character.DIRECTIONALITY_UNDEFINED);
    }
    ...
    static void reserveMemory(long r12, int r14) {
        /*
            r10 = 1
            java.lang.Class<java.nio.Bits> r2 = java.nio.Bits.class
            monitor-enter(r2)
            boolean r1 = memoryLimitSet     // Catch:{ all -> 0x0056 }
            if (r1 != 0) goto L_0x0018
            boolean r1 = sun.misc.VM.isBooted()     // Catch:{ all -> 0x0056 }
            if (r1 == 0) goto L_0x0018
            long r4 = sun.misc.VM.maxDirectMemory()     // Catch:{ all -> 0x0056 }
            maxMemory = r4     // Catch:{ all -> 0x0056 }
            r1 = 1
            memoryLimitSet = r1     // Catch:{ all -> 0x0056 }
        L_0x0018:
            long r4 = (long) r14     // Catch:{ all -> 0x0056 }
            long r6 = maxMemory     // Catch:{ all -> 0x0056 }
            long r8 = totalCapacity     // Catch:{ all -> 0x0056 }
            long r6 = r6 - r8
            int r1 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r1 > 0) goto L_0x0034
            long r4 = reservedMemory     // Catch:{ all -> 0x0056 }
            long r4 = r4 + r12
            reservedMemory = r4     // Catch:{ all -> 0x0056 }
            long r4 = totalCapacity     // Catch:{ all -> 0x0056 }
            long r6 = (long) r14     // Catch:{ all -> 0x0056 }
            long r4 = r4 + r6
            totalCapacity = r4     // Catch:{ all -> 0x0056 }
            long r4 = count     // Catch:{ all -> 0x0056 }
            long r4 = r4 + r10
            count = r4     // Catch:{ all -> 0x0056 }
            monitor-exit(r2)
            return
        L_0x0034:
            monitor-exit(r2)
        ...
        L_0x003d:
            java.lang.Class<java.nio.Bits> r2 = java.nio.Bits.class
            monitor-enter(r2)
            long r4 = totalCapacity     // Catch:{ all -> 0x0053 }
            long r6 = (long) r14     // Catch:{ all -> 0x0053 }
            long r4 = r4 + r6
            long r6 = maxMemory     // Catch:{ all -> 0x0053 }
            int r1 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r1 <= 0) goto L_0x0062
            java.lang.OutOfMemoryError r1 = new java.lang.OutOfMemoryError     // Catch:{ all -> 0x0053 }
            java.lang.String r3 = "Direct buffer memory"
        ...
        L_0x0059:
            ...
            goto L_0x003d
        L_0x0062:
            long r4 = reservedMemory     // Catch:{ all -> 0x0053 }
            long r4 = r4 + r12
            reservedMemory = r4     // Catch:{ all -> 0x0053 }
            long r4 = totalCapacity     // Catch:{ all -> 0x0053 }
            long r6 = (long) r14     // Catch:{ all -> 0x0053 }
            long r4 = r4 + r6
            totalCapacity = r4     // Catch:{ all -> 0x0053 }
            long r4 = count     // Catch:{ all -> 0x0053 }
            long r4 = r4 + r10
            count = r4     // Catch:{ all -> 0x0053 }
            monitor-exit(r2)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: java.nio.Bits.reserveMemory(long, int):void");
    }
        ...
        synchronized (Bits.class) {
            if (reservedMemory > 0) {
                ...
                if (!f11assertionsDisabled) {
                    if (!(reservedMemory > -1 ? true : f11assertionsDisabled)) {

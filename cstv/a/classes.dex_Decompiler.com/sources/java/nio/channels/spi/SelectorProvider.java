...
public abstract class SelectorProvider {
    ...
    public static boolean loadProviderFromProperty() {
        ...
        try {
            ...
            throw new ServiceConfigurationError((String) null, x2);
        } catch (InstantiationException x3) {
            throw new ServiceConfigurationError((String) null, x3);
        } catch (SecurityException x4) {
            throw new ServiceConfigurationError((String) null, x4);
        }
    }

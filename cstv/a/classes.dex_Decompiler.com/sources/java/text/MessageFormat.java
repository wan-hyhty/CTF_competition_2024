...
public class MessageFormat extends Format {
    ...
    public final StringBuffer format(Object[] arguments, StringBuffer result, FieldPosition pos) {
        return subformat(arguments, result, pos, (List) null);
    }
    ...
    public final StringBuffer format(Object arguments, StringBuffer result, FieldPosition pos) {
        return subformat((Object[]) arguments, result, pos, (List) null);
    }
    ...
    public AttributedCharacterIterator formatToCharacterIterator(Object arguments) {
        ...
        subformat((Object[]) arguments, result, (FieldPosition) null, iterators);
        if (iterators.size() == 0) {
        ...
        while (i2 <= this.maxOffset) {
            ...
            if (len == 0 || this.pattern.regionMatches(patternOffset, source, sourceOffset, len)) {
                ...
                if (this.formats[i2] == null) {
                    ...
                    if (!source.substring(sourceOffset2, next).equals("{" + this.argumentNumbers[i2] + "}")) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.maxOffset != other.maxOffset || !this.pattern.equals(other.pattern)) {
            return false;
        }
        if (((this.locale == null || !this.locale.equals(other.locale)) && (this.locale != null || other.locale != null)) || !Arrays.equals(this.offsets, other.offsets) || !Arrays.equals(this.argumentNumbers, other.argumentNumbers)) {
            return false;
        }
        return Arrays.equals((Object[]) this.formats, (Object[]) other.formats);
    }

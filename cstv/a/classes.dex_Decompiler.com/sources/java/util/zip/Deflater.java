...
public class Deflater {
    ...
    static final /* synthetic */ boolean f102assertionsDisabled = false;
    ...
    public Deflater(int level2) {
        this(level2, f102assertionsDisabled);
    }

    public Deflater() {
        this(-1, f102assertionsDisabled);
    }
    ...
    public void reset() {
        synchronized (this.zsRef) {
            ...
            this.finish = f102assertionsDisabled;
            this.finished = f102assertionsDisabled;
            this.len = 0;
            this.off = 0;
            this.bytesWritten = 0;
            this.bytesRead = 0;
    ...
    private void ensureOpen() {
        if (!f102assertionsDisabled && !Thread.holdsLock(this.zsRef)) {

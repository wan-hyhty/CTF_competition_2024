...
public class EncryptedPrivateKeyInfo {
    ...
    public PKCS8EncodedKeySpec getKeySpec(Cipher cipher) throws InvalidKeySpecException {
        try {
            ...
            InvalidKeySpecException ikse = new InvalidKeySpecException("Cannot retrieve the PKCS8EncodedKeySpec");
            ikse.initCause(gse);
            throw ikse;
        } catch (IOException ioe) {
            InvalidKeySpecException ikse2 = new InvalidKeySpecException("Cannot retrieve the PKCS8EncodedKeySpec");
            ikse2.initCause(ioe);
            throw ikse2;
        } catch (IllegalStateException ise) {
            InvalidKeySpecException ikse3 = new InvalidKeySpecException("Cannot retrieve the PKCS8EncodedKeySpec");
            ikse3.initCause(ise);
            throw ikse3;
        }
    }
    ...
    private PKCS8EncodedKeySpec getKeySpecImpl(Key decryptKey, Provider provider) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        if (provider == null) {
            try {
                ...
                InvalidKeyException ike2 = new InvalidKeyException("Cannot retrieve the PKCS8EncodedKeySpec");
                ike2.initCause(ioe);
                throw ike2;
            }
        } else {
    ...
    public PKCS8EncodedKeySpec getKeySpec(Key decryptKey) throws NoSuchAlgorithmException, InvalidKeyException {
        if (decryptKey != null) {
            return getKeySpecImpl(decryptKey, (Provider) null);
        }

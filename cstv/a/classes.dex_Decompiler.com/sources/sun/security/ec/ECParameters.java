...
public final class ECParameters extends AlgorithmParametersSpi {
    ...
    public void engineInit(AlgorithmParameterSpec paramSpec2) throws InvalidParameterSpecException {
        if (paramSpec2 instanceof ECParameterSpec) {
            this.paramSpec = getNamedCurve((ECParameterSpec) paramSpec2);
            if (this.paramSpec == null) {
                throw new InvalidParameterSpecException("Not a supported named curve: " + paramSpec2);
            }
        } else if (paramSpec2 instanceof ECGenParameterSpec) {
            String name = ((ECGenParameterSpec) paramSpec2).getName();
            ECParameterSpec spec = NamedCurve.getECParameterSpec(name);
            if (spec == null) {
                throw new InvalidParameterSpecException("Unknown curve: " + name);
            }
            this.paramSpec = spec;
        } else if (paramSpec2 == null) {
    ...
    /* access modifiers changed from: protected */
    public void engineInit(byte[] params, String decodingMethod) throws IOException {
        engineInit(params);
    }

    /* access modifiers changed from: protected */
    public <T extends AlgorithmParameterSpec> T engineGetParameterSpec(Class<T> spec) throws InvalidParameterSpecException {
    ...
    /* access modifiers changed from: protected */
    public byte[] engineGetEncoded(String encodingMethod) throws IOException {
